                ...
                <tr>
                    ...
                    <td>
                        {{ Form::open(array('action' => array('DavidWeber\Dominion\Controllers\ModuleGroupController@postDelete', $moduleGroup->id))) }}
                            ...
                            <a href="{{action('DavidWeber\Dominion\Controllers\ModuleGroupController@getEdit', array('id' => $moduleGroup->id))}}" class="btn btn-xs btn-info"><span class="glyphicon glyphicon-edit"></span> Edit</a>
